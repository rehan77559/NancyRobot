...
buttons = [
    [
        InlineKeyboardButton(
            text="➕️ ᴀᴅᴅ ᴛᴏ ʏᴏᴜʀ ɢʀᴏᴜᴘ ➕️", url="t.me/NancyRobot?startgroup=true"),
    ],
    [
...
DONATE_STRING = """Heya, glad to hear you want to donate!
 ...
 Supporting isnt always financial! [vasu](t.me/vasuxd) \
...
def layla_about_callback(update, context):
    ...
    if query.data == "layla_":
        query.message.edit_text(
            text=""" ℹ️ I'm *★NสŇcץ★*, a powerful group management bot built to help you manage your group easily.
